...
export default function InventoryPage() {
  ...
  const [itemForm, setItemForm] = useState({ name: '', code: '', unitId: '', groupId: '', hsnSac: '', standardRate: 0, reorderLevel: 0, taxRateId: '', taxEffectiveFrom: new Date().toISOString().slice(0, 10), taxEffectiveTo: '' });
  const [taxForm, setTaxForm] = useState({ itemId: '', taxRateId: '', effectiveFrom: new Date().toISOString().slice(0, 10), effectiveTo: '' });
